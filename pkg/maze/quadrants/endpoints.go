...
// Endpoints collects all of the endpoints that compose the quadrant  It's
...
type UpdateResponse struct {
	M0 quadrantsdomain.Quadrant
	E1 error
}

// NewEndpoints return a new instance of the endpoint that wraps the provided
func NewEndpoints(svc quadrantsdomain.QuadrantsService) (ep Endpoints) {
...
func MakeCreateEndpoint(svc quadrantsdomain.QuadrantsService) (ep endpoint.Endpoint) {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(quadrantsdomain.Quadrant)
		return svc.Create(ctx, req)
	}
}

// MakeDeleteEndpoint returns an endpoint that invokes Delete on the
func MakeDeleteEndpoint(svc quadrantsdomain.QuadrantsService) (ep endpoint.Endpoint) {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
...
func MakeGetEndpoint(svc quadrantsdomain.QuadrantsService) (ep endpoint.Endpoint) {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(ByIDRequest)
...
func MakeGetAllEndpoint(svc quadrantsdomain.QuadrantsService) (ep endpoint.Endpoint) {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(quadrantsdomain.Pagination)
		return svc.GetAll(ctx, req)
	}
}

// MakeUpdateEndpoint returns an endpoint that invokes Update on the
func MakeUpdateEndpoint(svc quadrantsdomain.QuadrantsService) (ep endpoint.Endpoint) {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req := request.(UpdateRequest)
		return svc.Update(ctx, req.Quadrant)
	}
}
